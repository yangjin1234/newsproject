		...
		<div id="sidebar" class="sidebar">
			<header id="masthead" class="site-header" role="banner">
				<div class="site-branding">
											<h1 class="site-title"><a href="./MainShow.jsp" rel="home"><font color="#006699">新媒体平台</font></a></h1>
...
<div id="primary" class="content-area">
	...
	<article id="post-486354" class="post-486354 post type-post status-publish format-standard hentry category-jstw">
		<header class="entry-header"><span style="color:#ffffff; background-color:#006699;">文号：${listc.nid }</span><h2 class="entry-title" style="margin-bottom:15px;"><a href="./MainShow.jsp" rel="bookmark">${listc.title }</a></h2><div style="font-size:85%;margin-bottom:10px;"><span class="posted-on"><span class="screen-reader-text">发布于 </span><a href="MainShow.jsp" rel="bookmark"><time class="entry-date published" datetime="2019-05-08T16:51:15+00:00">2019年05月08日 16:51</time><time class="updated" datetime="2019-05-09T17:45:34+00:00">2019年05月09日 17:45</time></a></span><span class="byline"><span class="author vcard"><span class="screen-reader-text">作者 </span><a class="url fn n" href="./MainShow.jsp">${listc.uname }</a></span></span><span class="cat-links"><span class="screen-reader-text">分类 </span><a href="./MainShow.jsp" rel="category tag">${listc.typename }</a></span><span class="comments-link"><a href="./MainShow.jsp"></span></div>	</header><!-- .entry-header -->
...
<script type='text/javascript' src='./wp-includes/js/wp-embed.min.js?ver=4.7.53'></script>
		...
		<li id="wp-admin-bar-site-name" class="menupop"><a class="ab-item" aria-haspopup="true" href="./MainShow.jsp">新媒体平台</a><div class="ab-sub-wrapper"><ul id="wp-admin-bar-site-name-default" class="ab-submenu">
		...
		<li id="wp-admin-bar-search" class="admin-bar-search"><div class="ab-item ab-empty-item" tabindex="-1"><form action="./" method="get" id="adminbarsearch"><input class="adminbar-input" name="s" id="adminbar-search" type="text" value="" maxlength="150" /></form></div>		</li>
		<li id="wp-admin-bar-my-account" class="menupop with-avatar"><a class="ab-item" aria-haspopup="true" href="./profile1.do?param=selectUser">嗨，${sessionScope.account.lname }<img alt='' src='https://secure.gravatar.com/avatar/989d4d63bcd4bd0c59f6d2edd762ed80?s=26&#038;d=wavatar&#038;r=g' srcset='./${sessionScope.uphoto }'' class='avatar avatar-26 photo' height='26' width='26' /></a><div class="ab-sub-wrapper"><ul id="wp-admin-bar-user-actions" class="ab-submenu">
		<li id="wp-admin-bar-user-info"><a class="ab-item" tabindex="-1" href="./profile1.do?param=selectUser"><img alt='' src='https://secure.gravatar.com/avatar/989d4d63bcd4bd0c59f6d2edd762ed80?s=64&#038;d=wavatar&#038;r=g' srcset='./${sessionScope.uphoto }'' class='avatar avatar-64 photo' height='64' width='64' /><span class='display-name'>${sessionScope.account.lname }</span></a>		</li>
		<li id="wp-admin-bar-edit-profile"><a class="ab-item" href="./profile1.do?param=selectUser">编辑我的个人资料</a>		</li>
