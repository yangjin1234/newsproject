...
<form name="loginform" id="loginform" action="login.do" method="post">
	...
	<p class="submit">
		<input type="button" id="wp-submit" class="button button-primary button-large" onclick="ajaxInvoke()"value="登录" />
...
<p id="nav">
<a href="./register.jsp">注册</a> | 	<a href="./forgetpass.jsp">忘记密码？</a>
</p>
