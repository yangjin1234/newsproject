...
<div id="wpcontent">
		...
		<li id="wp-admin-bar-my-account" class="menupop with-avatar"><a class="ab-item" aria-haspopup="true" href="https://weilaiche.cc/wp-admin/profile.php">嗨，${loginname}<img alt='' src='./${sessionScope.uphoto }' srcset='./${sessionScope.uphoto }' class='avatar avatar-26 photo' height='26' width='26' /></a><div class="ab-sub-wrapper"><ul id="wp-admin-bar-user-actions" class="ab-submenu">
		<li id="wp-admin-bar-user-info"><a class="ab-item" tabindex="-1" href="https://weilaiche.cc/wp-admin/profile.php"><img alt='' src='https://secure.gravatar.com/avatar/54311cd9e80d1ddcad3697b15ae032be?s=64&#038;d=wavatar&#038;r=g' srcset='./${sessionScope.uphoto }'' class='avatar avatar-64 photo' height='64' width='64' /><span class='display-name'>Rasery</span></a>		</li>
