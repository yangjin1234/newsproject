...
<h1>
个人资料</h1>
<form id="your-profile" action="https://weilaiche.cc/wp-admin/profile.php" method="post" novalidate="novalidate">
<input type="hidden" id="_wpnonce" name="_wpnonce" value="df44a50981" /><input type="hidden" name="_wp_http_referer" value="/wp-admin/profile.php" /><p>
<input type="hidden" name="from" value="profile" />
<input type="hidden" name="checkuser_id" value="1089" />
</p>
...
<table class="form-table">
	<tr class="user-rich-editing-wrap">
		...
		<td><label for="rich_editing"><input name="rich_editing" type="checkbox" id="rich_editing" value="false"  /> 撰写文章时不使用可视化编辑器</label></td>
	</tr>
...
<td>	<fieldset id="color-picker" class="scheme-list">
		...
		<input type="hidden" id="color-nonce" name="color-nonce" value="62f5f82b76" />			<div class="color-option ">
				...
				<input name="admin_color" id="admin_color_light" type="radio" value="light" class="tog"  checked='checked' />
				...
				<input type="hidden" class="css_url" value="https://weilaiche.cc/wp-admin/css/colors/blue/colors.min.css" />
				...
				<input type="hidden" class="css_url" value="https://weilaiche.cc/wp-admin/css/colors/coffee/colors.min.css" />
				...
				<input type="hidden" class="css_url" value="https://weilaiche.cc/wp-admin/css/colors/ectoplasm/colors.min.css" />
				...
				<input type="hidden" class="css_url" value="https://weilaiche.cc/wp-admin/css/colors/midnight/colors.min.css" />
				...
				<input type="hidden" class="css_url" value="https://weilaiche.cc/wp-admin/css/colors/ocean/colors.min.css" />
				...
				<input type="hidden" class="css_url" value="https://weilaiche.cc/wp-admin/css/colors/sunrise/colors.min.css" />
...
<td><label for="comment_shortcuts"><input type="checkbox" name="comment_shortcuts" id="comment_shortcuts" value="true"  /> 管理评论时启用键盘快捷键。</label> <a href="https://codex.wordpress.org/Keyboard_Shortcuts" target="_blank">更多信息</a></td>
</tr>
...
<tr class="user-language-wrap">
	...
	<td>
		<select name="locale" id="locale"><option value="site-default" data-installed="1" selected='selected'>站点默认</option>
...
<tr class="user-first-name-wrap">
	...
	<td><input type="text" name="first_name" id="first_name" value="Rasery" class="regular-text" /></td>
</tr>
...
<tr class="user-nickname-wrap">
	...
	<td><input type="text" name="nickname" id="nickname" value="Rasery" class="regular-text" /></td>
</tr>
...
<tr class="pw-weak">
	...
	<input name="pods_meta" data-name-clean="pods-meta" id="pods-form-ui-pods-meta" class="pods-form-ui-field pods-form-ui-field-type-text pods-form-ui-field-name-pods-meta" type="hidden" value="0ff28bcf6b" />
...
<input type="hidden" name="user_id" id="user_id" value="1089" />
